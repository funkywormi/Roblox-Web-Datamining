...
import { Gender as GenderType } from "@rbx/authentication-common/types/signupTypes";
import {
...
const GenderPicker = ({ gender, setSelectedGender, translate }: genderPickerProps): JSX.Element => {
  useSignupAuditContent(signupFormStrings.OptionalGender, translate);

  return (
    <div className="gender-container">
      <label htmlFor="landing-gender" className="font-caption-header">
        {translate(signupFormStrings.OptionalGender)}
      </label>
