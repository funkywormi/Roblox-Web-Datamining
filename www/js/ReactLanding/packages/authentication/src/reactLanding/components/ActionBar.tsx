...
import { RETURNURL } from "@rbx/authentication-common/constants/browserConstants";
...
export const ActionBar = ({ usesFoundationSignIn = false }: ActionBarProps): JSX.Element => {
