...
import { KoreaSignupCompliancePolicyCheckboxType } from "@rbx/authentication-common/types/signupTypes";
...
const KoreaSignupComplianceComponent = ({
  ...
  const [isPersonalInformationPolicyChecked, setIsPersonalInformationPolicyChecked] =
    useState(false);
  const [
...
export default KoreaSignupComplianceComponent;
