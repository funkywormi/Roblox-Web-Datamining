...
import { TSignupParams, Gender } from "@rbx/authentication-common/types/signupTypes";
import {
...
import { navigateToLogin, navigateToPage } from "@rbx/authentication-common/utils/browserUtils";
import {
...
const { birthdayDay, birthdayMonth, birthdayYear, signupUsername, signupPassword, usernameValid } =
...
const handleAccountLimitConfirmation = (): void => {
...
const handleSignupModal = ({
  ...
  switch (modal.type) {
    case "maxAccounts":
      showMaxLoggedInAccountsModal(translate, handleAccountLimitConfirmation);
      break;
    case "emptyBlob":
