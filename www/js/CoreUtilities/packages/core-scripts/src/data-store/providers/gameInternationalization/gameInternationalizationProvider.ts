...
export const AutolocalizationApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    v1AutolocalizationGamesGameIdAutolocalizationtablePatch: async (
      ...
      const localVarPath = `/v1/autolocalization/games/{gameId}/autolocalizationtable`.replace(
        `{${"gameId"}}`,
    ...
    v1AutolocalizationGamesGameIdAutoscrapeCleanupRequestPost: async (
      ...
      const localVarPath = `/v1/autolocalization/games/{gameId}/autoscrape-cleanup-request`.replace(
        `{${"gameId"}}`,
        encodeURIComponent(String(gameId)),
      );
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
    ...
    v1AutolocalizationGamesGameIdSettingsPatch: async (
      ...
      const localVarPath = `/v1/autolocalization/games/{gameId}/settings`.replace(
        `{${"gameId"}}`,
        encodeURIComponent(String(gameId)),
      );
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
  ...
  return {
    ...
    async v1AutolocalizationGamesGameIdAutolocalizationtablePatch(
      ...
      const localVarAxiosArgs = await AutolocalizationApiAxiosParamCreator(
        configuration,
      ).v1AutolocalizationGamesGameIdAutolocalizationtablePatch(gameId, request, options);
    ...
    async v1AutolocalizationGamesGameIdAutoscrapeCleanupRequestPost(
      ...
      const localVarAxiosArgs = await AutolocalizationApiAxiosParamCreator(
        configuration,
      ).v1AutolocalizationGamesGameIdAutoscrapeCleanupRequestPost(gameId, request, options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
    ...
    > {
      const localVarAxiosArgs =
        await AutolocalizationApiAxiosParamCreator(configuration).v1AutolocalizationMetadataGet(
          options,
        );
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
...
export const AutomaticTranslationApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    v1AutomaticTranslationGamesGameIdFeatureStatusGet: async (
      ...
      const localVarPath = `/v1/automatic-translation/games/{gameId}/feature-status`.replace(
        `{${"gameId"}}`,
        encodeURIComponent(String(gameId)),
      );
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
    ...
    v1AutomaticTranslationGamesGameIdQuotaGet: async (
      ...
      const localVarPath = `/v1/automatic-translation/games/{gameId}/quota`.replace(
        `{${"gameId"}}`,
        encodeURIComponent(String(gameId)),
      );
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
...
export const BadgeApiFp = function (configuration?: Configuration) {
  return {
    ...
    async v1BadgesBadgeIdIconsLanguageCodesLanguageCodeDelete(
      ...
      const localVarAxiosArgs = await BadgeApiAxiosParamCreator(
        configuration,
      ).v1BadgesBadgeIdIconsLanguageCodesLanguageCodeDelete(badgeId, languageCode, options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
    ...
    > {
      const localVarAxiosArgs = await BadgeApiAxiosParamCreator(
        configuration,
      ).v1BadgesBadgeIdNameLanguageCodesLanguageCodePatch(badgeId, languageCode, request, options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
...
export class BadgeApi extends BaseAPI implements BadgeApiInterface {
  ...
  public v1BadgesBadgeIdNameDescriptionLanguageCodesLanguageCodeDelete(
    ...
    return BadgeApiFp(this.configuration)
      .v1BadgesBadgeIdNameDescriptionLanguageCodesLanguageCodeDelete(badgeId, languageCode, options)
      .then(request => request(this.axios, this.basePath));
  }
...
export const DeveloperProductApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    v1DeveloperProductsDeveloperProductIdDescriptionLanguageCodesLanguageCodePatch: async (
    ...
    v1DeveloperProductsDeveloperProductIdIconsGet: async (
      ...
      const localVarPath = `/v1/developer-products/{developerProductId}/icons`.replace(
        `{${"developerProductId"}}`,
     ...
     * @throws {RequiredError}
     */
    v1DeveloperProductsDeveloperProductIdIconsLanguageCodesLanguageCodeDelete: async (
      developerProductId: number,
      languageCode: string,
      options: any = {},
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    v1DeveloperProductsDeveloperProductIdIconsLanguageCodesLanguageCodePost: async (
      developerProductId: number,
      languageCode: string,
      requestFiles?: any,
      options: any = {},
    ...
    v1DeveloperProductsDeveloperProductIdNameDescriptionGet: async (
      ...
      const localVarPath = `/v1/developer-products/{developerProductId}/name-description`.replace(
        `{${"developerProductId"}}`,
        encodeURIComponent(String(developerProductId)),
      );
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
     ...
     * @throws {RequiredError}
     */
    v1DeveloperProductsDeveloperProductIdNameDescriptionLanguageCodesLanguageCodeDelete: async (
      developerProductId: number,
      languageCode: string,
      options: any = {},
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    v1DeveloperProductsDeveloperProductIdNameDescriptionLanguageCodesLanguageCodePatch: async (
      developerProductId: number,
      languageCode: string,
     ...
     * @throws {RequiredError}
     */
    v1DeveloperProductsDeveloperProductIdNameLanguageCodesLanguageCodePatch: async (
      developerProductId: number,
      languageCode: string,
...
export const DeveloperProductApiFp = function (configuration?: Configuration) {
  return {
    ...
    > {
      const localVarAxiosArgs = await DeveloperProductApiAxiosParamCreator(
        configuration,
      ).v1DeveloperProductsDeveloperProductIdIconsGet(developerProductId, width, height, options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
    ...
    > {
      const localVarAxiosArgs = await DeveloperProductApiAxiosParamCreator(
        configuration,
      ).v1DeveloperProductsDeveloperProductIdNameDescriptionGet(developerProductId, options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
...
export const GameIconApiFp = function (configuration?: Configuration) {
  return {
    ...
    async v1GameIconGamesGameIdLanguageCodesLanguageCodeDelete(
      ...
      const localVarAxiosArgs = await GameIconApiAxiosParamCreator(
        configuration,
      ).v1GameIconGamesGameIdLanguageCodesLanguageCodeDelete(gameId, languageCode, options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
...
export const GameLocalizationStatusApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    v1GameLocalizationStatusGameIdTranslationCountsGet: async (
      ...
      const localVarPath = `/v1/game-localization-status/{gameId}/translation-counts`.replace(
        `{${"gameId"}}`,
        encodeURIComponent(String(gameId)),
      );
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
...
export const GameLocalizationStatusApiFp = function (configuration?: Configuration) {
  return {
    ...
    > {
      const localVarAxiosArgs = await GameLocalizationStatusApiAxiosParamCreator(
        configuration,
...
export const GamePassApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    v1GamePassesGamePassIdNameDescriptionGet: async (
      ...
      const localVarPath = `/v1/game-passes/{gamePassId}/name-description`.replace(
        `{${"gamePassId"}}`,
        encodeURIComponent(String(gamePassId)),
      );
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
     ...
     * @throws {RequiredError}
     */
    v1GamePassesGamePassIdNameDescriptionLanguageCodesLanguageCodeDelete: async (
      gamePassId: number,
      languageCode: string,
      options: any = {},
    ): Promise<RequestArgs> => {
...
export class GamePassApi extends BaseAPI implements GamePassApiInterface {
  ...
  public v1GamePassesGamePassIdIconsLanguageCodesLanguageCodeDelete(
    ...
    return GamePassApiFp(this.configuration)
      .v1GamePassesGamePassIdIconsLanguageCodesLanguageCodeDelete(gamePassId, languageCode, options)
      .then(request => request(this.axios, this.basePath));
  }
...
export const GameThumbnailsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    v1GameThumbnailsGamesGameIdLanguageCodesLanguageCodeImagesImageIdDelete: async (
      gameId: number,
      languageCode: string,
      imageId: number,
      options: any = {},
...
export const LocalizationTableApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    v1LocalizationtableGamesGameIdAssetsGenerationRequestPost: async (
      ...
      const localVarPath = `/v1/localizationtable/games/{gameId}/assets-generation-request`.replace(
        `{${"gameId"}}`,
        encodeURIComponent(String(gameId)),
      );
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
    ...
    v1LocalizationtableTablesTableIdEntriesGet: async (
      ...
      const localVarPath = `/v1/localizationtable/tables/{tableId}/entries`.replace(
        `{${"tableId"}}`,
    ...
    v1LocalizationtableTablesTableIdEntryCountGet: async (
      ...
      const localVarPath = `/v1/localizationtable/tables/{tableId}/entry-count`.replace(
        `{${"tableId"}}`,
        encodeURIComponent(String(tableId)),
      );
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
  ...
  return {
    ...
    async v1LocalizationtableGamesGameIdAssetsGenerationRequestPost(
      ...
      const localVarAxiosArgs = await LocalizationTableApiAxiosParamCreator(
        configuration,
      ).v1LocalizationtableGamesGameIdAssetsGenerationRequestPost(gameId, options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
    ...
    > {
      const localVarAxiosArgs = await LocalizationTableApiAxiosParamCreator(
        configuration,
      ).v1LocalizationtableTablesTableIdEntriesGet(tableId, cursor, gameId, options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
...
export const NameDescriptionApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    v1NameDescriptionGamesGameIdHistoryPost: async (
      ...
      const localVarPath = `/v1/name-description/games/{gameId}/history`.replace(
        `{${"gameId"}}`,
        encodeURIComponent(String(gameId)),
      );
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
...
export const NameDescriptionApiFp = function (configuration?: Configuration) {
  return {
    ...
    > {
      const localVarAxiosArgs =
        await NameDescriptionApiAxiosParamCreator(configuration).v1NameDescriptionMetadataGet(
          options,
        );
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
...
export const PlayerPolicyApiFp = function (configuration?: Configuration) {
  return {
    ...
    > {
      const localVarAxiosArgs =
        await PlayerPolicyApiAxiosParamCreator(configuration).v1PlayerPoliciesAllValuesGet(options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
    ...
    > {
      const localVarAxiosArgs =
        await PlayerPolicyApiAxiosParamCreator(configuration).v1PlayerPoliciesClientGet(options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
...
export const SupportedLanguagesApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    v1SupportedLanguagesGamesGameIdLanguagesLanguageCodeAutomaticTranslationStatusPatch: async (
      gameId: number,
      languageCode: string,
      ...
      const needsSerialization =
        ...
        localVarRequestOptions.headers["Content-Type"] === "application/json";
      localVarRequestOptions.data = needsSerialization
        ? JSON.stringify(enableAutomaticTranslation !== undefined ? enableAutomaticTranslation : {})
        : enableAutomaticTranslation || "";
     ...
     * @throws {RequiredError}
     */
    v1SupportedLanguagesGamesGameIdUniverseDisplayInfoAutomaticTranslationSettingsGet: async (
      gameId: number,
      options: any = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'gameId' is not null or undefined
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await SupportedLanguagesApiAxiosParamCreator(
        configuration,
      ).v1SupportedLanguagesGamesGameIdAutomaticTranslationStatusGet(gameId, options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
    ...
    > {
      const localVarAxiosArgs =
        await SupportedLanguagesApiAxiosParamCreator(configuration).v1SupportedLanguagesMetadataGet(
          options,
        );
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
...
export const TranslationAnalyticsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    v1TranslationAnalyticsGamesGameIdDownloadTranslationAnalyticsReportGet: async (
      gameId: number,
      startDateTime: string,
      endDateTime: string,
      reportType:
     ...
     * @throws {RequiredError}
     */
    v1TranslationAnalyticsGamesGameIdRequestTranslationAnalyticsReportPost: async (
      gameId: number,
...
export const UiConfigurationsApiFp = function (configuration?: Configuration) {
  return {
    ...
    > {
      const localVarAxiosArgs =
        await UiConfigurationsApiAxiosParamCreator(configuration).v1UiConfigurationsGet(options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
