...
import {
  TCaptchaInputParams,
  TOnCaptchaChallengeDisplayedData,
...
export const CaptchaComponent = ({
  ...
  const handleCaptcha = (inputParams: TCaptchaInputParams) => {
    ...
    const challengeParam: TCaptchaChallengeParameters = {
      ...
      onChallengeDisplayed: (_data: TOnCaptchaChallengeDisplayedData) => {
        return null;
      },
      onChallengeCompleted: (data: TOnCaptchaChallengeCompletedData) => {
        setRestoreModal(null);
        onCaptchaChallengeCompleted(data);
      },
      onChallengeInvalidated: (data: TOnCaptchaChallengeInvalidatedData) => {
        setRestoreModal(null);
      ...
      onModalChallengeAbandoned: (restoreModalInner: () => void) => {
