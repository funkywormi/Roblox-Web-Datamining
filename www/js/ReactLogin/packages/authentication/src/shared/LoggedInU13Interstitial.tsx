...
import { defaultRedirect } from "@rbx/authentication-common/utils/browserUtils";
import "../accountSwitcher/css/loggedInU13Interstitial.css";
...
export const LoggedInU13Interstitial = ({ context }: LoggedInU13InterstitialProps): JSX.Element => {
...
export default LoggedInU13Interstitial;
