...
} from "@rbx/authentication-common/types/loginTypes";

import { TLoginWithAuthTokenParams } from "@rbx/authentication-common/types/crossDeviceLoginTypes";
import { TEnterCodeErrorEvent } from "@rbx/authentication-common/types/otpTypes";
// services
import { getOtpMetadata } from "@rbx/authentication-common/services/otpService";
import {
  getPasskeyChallenge,
  isPasskeyLoginEnabled,
} from "@rbx/authentication-common/services/passkeyService";
...
// utils
import { detectInputMethod, InputMethod } from "@rbx/authentication-common/utils/inputMethodUtils";
import {
  defaultRedirect,
  navigateToLogin,
  navigateToPage,
...
export const LoginBase = (): JSX.Element => {
  ...
  const loginSilentUpgradeBrowserCheck =
    loginExperiments.loginSilentUpgradeBrowserCheck as SilentPasskeyUpgradeVariant;
