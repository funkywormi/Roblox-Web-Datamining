...
export const CountryRegionsApiFp = function (configuration?: Configuration) {
  return {
    ...
    v1CountryRegionsGet(
      options?: any,
    ): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<CountryRegionListResponse> {
      const localVarAxiosArgs =
        CountryRegionsApiAxiosParamCreator(configuration).v1CountryRegionsGet(options);
    ...
    v1CountryRegionsUserCountryRegionGet(
      options?: any,
    ): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserCountryRegionResponse> {
      const localVarAxiosArgs =
        CountryRegionsApiAxiosParamCreator(configuration).v1CountryRegionsUserCountryRegionGet(
          options,
        );
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
...
export const CountryRegionsApiFactory = function (
  ...
  return {
    ...
    v1CountryRegionsUserCountryRegionGet(options?: any) {
      return CountryRegionsApiFp(configuration).v1CountryRegionsUserCountryRegionGet(options)(
        axios,
        basePath,
      );
    },
    ...
    v1CountryRegionsUserCountryRegionPatch(
      ...
      return CountryRegionsApiFp(configuration).v1CountryRegionsUserCountryRegionPatch(
        userRequest,
        options,
      )(axios, basePath);
    },
...
export class CountryRegionsApi extends BaseAPI implements CountryRegionsApiInterface {
  ...
  public v1CountryRegionsUserCountryRegionGet(options?: any) {
    return CountryRegionsApiFp(this.configuration).v1CountryRegionsUserCountryRegionGet(options)(
      this.axios,
      this.basePath,
    );
  }
  ...
  public v1CountryRegionsUserCountryRegionPatch(
    ...
    return CountryRegionsApiFp(this.configuration).v1CountryRegionsUserCountryRegionPatch(
      userRequest,
      options,
...
export const LanguageApiFp = function (configuration?: Configuration) {
  return {
    ...
    v1LanguagesGet(
      options?: any,
    ): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiArrayResponseLanguage> {
    ...
    v1LanguagesUserGeneratedContentGet(
      ...
      const localVarAxiosArgs =
        LanguageApiAxiosParamCreator(configuration).v1LanguagesUserGeneratedContentGet(options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
...
export const LanguageApiFactory = function (
  ...
  return {
    ...
    v1LanguagesUserGeneratedContentGet(options?: any) {
      return LanguageApiFp(configuration).v1LanguagesUserGeneratedContentGet(options)(
        axios,
        basePath,
      );
    },
...
export class LanguageApi extends BaseAPI implements LanguageApiInterface {
  ...
  public v1LanguagesUserGeneratedContentGet(options?: any) {
    return LanguageApiFp(this.configuration).v1LanguagesUserGeneratedContentGet(options)(
      this.axios,
      this.basePath,
    );
  }
...
export const LocaleApiFp = function (configuration?: Configuration) {
  return {
    ...
    v1LocalesSupportedLocalesGet(
      options?: any,
    ): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<SupportedLocalesResponse> {
      const localVarAxiosArgs =
        LocaleApiAxiosParamCreator(configuration).v1LocalesSupportedLocalesGet(options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
    ...
    v1LocalesUserLocaleGet(
      options?: any,
    ): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserLocaleResponse> {
      const localVarAxiosArgs =
        LocaleApiAxiosParamCreator(configuration).v1LocalesUserLocaleGet(options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
    ...
    v1LocalesUserLocalizationLocusSupportedLocalesGet(
      ...
      const localVarAxiosArgs =
        LocaleApiAxiosParamCreator(configuration).v1LocalesUserLocalizationLocusSupportedLocalesGet(
          options,
        );
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
...
export const LocaleApiFactory = function (
  ...
  return {
    ...
    v1LocalesSetUserSupportedLocalePost(
      ...
      return LocaleApiFp(configuration).v1LocalesSetUserSupportedLocalePost(userRequest, options)(
        axios,
        basePath,
      );
    },
    ...
    v1LocalesUserLocalizationLocusSupportedLocalesGet(options?: any) {
      return LocaleApiFp(configuration).v1LocalesUserLocalizationLocusSupportedLocalesGet(options)(
        axios,
        basePath,
      );
    },
...
export class LocaleApi extends BaseAPI implements LocaleApiInterface {
  ...
  public v1LocalesSupportedLocalesGet(options?: any) {
    return LocaleApiFp(this.configuration).v1LocalesSupportedLocalesGet(options)(
      this.axios,
      this.basePath,
    );
  }
  ...
  public v1LocalesUserLocalizationLocusSupportedLocalesGet(options?: any) {
    return LocaleApiFp(this.configuration).v1LocalesUserLocalizationLocusSupportedLocalesGet(
      options,
    )(this.axios, this.basePath);
  }
}
