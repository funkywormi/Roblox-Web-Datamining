...
export const GameLocalizationRolesApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    v1GameLocalizationRolesGamesGameIdCurrentUserRolesGet(
      ...
      const localVarPath = `/v1/game-localization-roles/games/{gameId}/current-user/roles`.replace(
        `{${"gameId"}}`,
    ...
    v1GameLocalizationRolesRolesRoleCurrentUserGet(
      ...
      const localVarPath = `/v1/game-localization-roles/roles/{role}/current-user`.replace(
        `{${"role"}}`,
...
export const GameLocalizationRolesApiFp = function (configuration?: Configuration) {
  return {
    ...
    v1GameLocalizationRolesGamesGameIdRolesRoleAssigneesGet(
      ...
      const localVarAxiosArgs = GameLocalizationRolesApiAxiosParamCreator(
        configuration,
      ).v1GameLocalizationRolesGamesGameIdRolesRoleAssigneesGet(gameId, role, options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
  ...
  return {
    ...
    v1GameLocalizationRolesGamesGameIdCurrentUserRolesGet(gameId: number, options?: any) {
      return GameLocalizationRolesApiFp(
        configuration,
      ).v1GameLocalizationRolesGamesGameIdCurrentUserRolesGet(gameId, options)(axios, basePath);
    },
    /**
     *
     * @summary Assigns or revokes a role
    ...
    v1GameLocalizationRolesGamesGameIdPatch(
      ...
      return GameLocalizationRolesApiFp(configuration).v1GameLocalizationRolesGamesGameIdPatch(
        gameId,
        request,
        options,
      )(axios, basePath);
...
export class GameLocalizationRolesApi extends BaseAPI implements GameLocalizationRolesApiInterface {
  ...
  public v1GameLocalizationRolesGamesGameIdPatch(
    ...
    return GameLocalizationRolesApiFp(this.configuration).v1GameLocalizationRolesGamesGameIdPatch(
      gameId,
      request,
      options,
