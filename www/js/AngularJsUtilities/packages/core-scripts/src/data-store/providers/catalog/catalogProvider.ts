  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await CatalogApiAxiosParamCreator(configuration).v1CatalogMetadataGet(options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
    ...
    > {
      const localVarAxiosArgs =
        await CatalogApiAxiosParamCreator(configuration).v1CatalogSortsGet(options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
...
export const CategoryApiFp = function (configuration?: Configuration) {
  return {
    ...
    > {
      const localVarAxiosArgs =
        await CategoryApiAxiosParamCreator(configuration).v1AssetToCategoryGet(options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
    ...
    > {
      const localVarAxiosArgs =
        await CategoryApiAxiosParamCreator(configuration).v1AssetToSubcategoryGet(options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
    ...
    > {
      const localVarAxiosArgs =
        await CategoryApiAxiosParamCreator(configuration).v1CategoriesGet(options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
    ...
    > {
      const localVarAxiosArgs =
        await CategoryApiAxiosParamCreator(configuration).v1SubcategoriesGet(options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
...
export const SearchApiFp = function (configuration?: Configuration) {
  return {
    ...
    > {
      const localVarAxiosArgs =
        await SearchApiAxiosParamCreator(configuration).v1SearchNavigationMenuItemsGet(options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
