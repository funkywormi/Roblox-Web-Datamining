...
export const AutoLocalizationTableApiFactory = function (
  ...
  return {
    ...
    v1AutoLocalizationTableGamesGameIdAssetsGenerationRequestPost(
      ...
      return localVarFp
        .v1AutoLocalizationTableGamesGameIdAssetsGenerationRequestPost(gameId, options)
    ...
    v1AutoLocalizationTableGamesGameIdAutoScrapeCleanupRequestPost(
      ...
      return localVarFp
        .v1AutoLocalizationTableGamesGameIdAutoScrapeCleanupRequestPost(gameId, request, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    v1AutoLocalizationTableGamesGameIdPatch(
      ...
      return localVarFp
        .v1AutoLocalizationTableGamesGameIdPatch(gameId, request, robloxGameId, options)
        .then(request => request(axios, basePath));
    },
  };
};
...
export const LocalizationTableApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    v1LocalizationTableTablesTableIdEntriesGet: async (
      ...
      const localVarPath = `/v1/localization-table/tables/{tableId}/entries`.replace(
        `{${"tableId"}}`,
    ...
    v1LocalizationTableTablesTableIdEntryCountGet: async (
      ...
      const localVarPath = `/v1/localization-table/tables/{tableId}/entry-count`.replace(
        `{${"tableId"}}`,
        encodeURIComponent(String(tableId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const LocalizationTableApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1LocalizationTableAvailableLanguagesGet(options);
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
    },
    /**
     *
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1LocalizationTableTablesAssetIdGet(
        assetId,
        options,
      );
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1LocalizationTableTablesPost(
        request,
        options,
      );
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1LocalizationTableTablesTableIdGet(
        tableId,
        options,
      );
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
