...
export const GamesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v2GamesUniverseIdMediaGet(
        universeId,
        options,
      );
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v2GroupsGroupIdGamesGet(
        groupId,
        accessFilter,
        sortOrder,
        limit,
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v2GroupsGroupIdGamesV2Get(
        groupId,
        accessFilter,
        sortOrder,
        limit,
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v2UsersUserIdFavoriteGamesGet(
        userId,
        accessFilter,
        sortOrder,
        limit,
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v2UsersUserIdGamesGet(
        userId,
        accessFilter,
        sortOrder,
        limit,
...
export const GamesApiFactory = function (
  ...
  return {
    ...
    v2GroupsGroupIdGamesGet(
      ...
      return localVarFp
        .v2GroupsGroupIdGamesGet(groupId, accessFilter, sortOrder, limit, cursor, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    v2GroupsGroupIdGamesV2Get(
      ...
      return localVarFp
        .v2GroupsGroupIdGamesV2Get(groupId, accessFilter, sortOrder, limit, cursor, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    v2UsersUserIdFavoriteGamesGet(
      ...
      return localVarFp
        .v2UsersUserIdFavoriteGamesGet(userId, accessFilter, sortOrder, limit, cursor, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    v2UsersUserIdGamesGet(
      ...
      return localVarFp
        .v2UsersUserIdGamesGet(userId, accessFilter, sortOrder, limit, cursor, options)
        .then(request => request(axios, basePath));
    },
  };
};
