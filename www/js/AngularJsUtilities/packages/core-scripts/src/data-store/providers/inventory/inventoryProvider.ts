...
export const AssetsApiFp = function (configuration?: Configuration) {
  return {
    ...
    v2AssetsAssetIdOwnersGet(
      ...
      const localVarAxiosArgs = AssetsApiAxiosParamCreator(configuration).v2AssetsAssetIdOwnersGet(
        assetId,
        sortOrder,
        limit,
        cursor,
...
export const InventoryApiFp = function (configuration?: Configuration) {
  return {
    ...
    v2UsersUserIdInventoryAssetTypeIdGet(
      ...
      cursor?: string,
      options?: any,
    ): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiPageResponseUserAssetModel> {
...
export class InventoryApi extends BaseAPI implements InventoryApiInterface {
  ...
  public v2UsersUserIdInventoryAssetTypeIdGet(
    ...
    return InventoryApiFp(this.configuration).v2UsersUserIdInventoryAssetTypeIdGet(
      userId,
      assetTypeId,
      sortOrder,
      limit,
