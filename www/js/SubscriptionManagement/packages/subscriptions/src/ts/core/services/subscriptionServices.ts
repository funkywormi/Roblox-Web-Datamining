 ...
 */
/**
 * Returns the product id of the 1-week FAE free-trial Blackbird product, or null if unavailable.
 */
export const getFaeTrialProductId = async (): Promise<string | null> => {
  try {
