...
import BrazilApp from "@rbx/illegal-content-report/ts/react/illegalContentReport/BrazilApp";
...
const renderApp = (): void => {
  if (osaContentReportEntryPoint) {
    ...
    renderWithErrorBoundary(
      <IllegalContentReportApp isUKUser={false} />,
      illegalContentReportEntryPoint,
    );
    ...
    renderWithErrorBoundary(<BrazilApp />, brazilEcaContentReportEntryPoint);
