...
const Urls = {
  ...
  BRAZIL_HELP_CENTER_ARTICLE:
    "https://en.help.roblox.com/hc/en-us/articles/48706630819476-Brazil-Digital-ECA-Updates",
};
...
// Character limits for Brazil women intimate / women-safety forms (PRD 1000-char max).
const BrazilWomenLimits = {
  MAX_DESCRIPTION_LENGTH: 1000,
  MAX_CIRCUMSTANCES_LENGTH: 1000,
  MAX_SIGNATURE_LENGTH: 200,
};
