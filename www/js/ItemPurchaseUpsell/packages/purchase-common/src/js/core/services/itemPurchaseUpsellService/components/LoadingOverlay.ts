export default class LoadingOverlay {
  ...
  private readonly getOrCreateContentDiv = (overlayDiv: HTMLDivElement): HTMLDivElement => {
    if (this.contentDiv) {
  ...
  private readonly getOrCreateSpinnerSpan = (contentDiv: HTMLDivElement): HTMLSpanElement => {
    if (this.spinnerSpan) {
