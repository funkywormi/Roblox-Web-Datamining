...
type TFoundationIconName = TIconProps["name"];
 ...
 */
const MARKETPLACE_OFFER_ICON_CLASS_BY_NAME: Record<string, TFoundationIconName> = {
...
export function marketplaceOfferIconToFilledFoundationName(
  ...
  return regular.replace("icon-regular-", "icon-filled-") as TFoundationIconName;
}
