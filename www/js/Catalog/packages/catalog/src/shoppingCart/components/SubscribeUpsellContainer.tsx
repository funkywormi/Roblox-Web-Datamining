...
import {
  ...
  TTimedOption,
} from "../../itemDetailsHydrationService/constants/itemDetailsHydrationConstants";
...
function SubscribeUpsellContainer({
  ...
  const { discountSummaries, totalSavings, hasFallbackSavings } = useMemo(() => {
    ...
    selectedItems.forEach(item => {
      ...
      if (discountInfo?.discounts && Array.isArray(discountInfo.discounts)) {
    ...
    return {
      discountSummaries: [...summaryMap.values()],
      totalSavings: total,
