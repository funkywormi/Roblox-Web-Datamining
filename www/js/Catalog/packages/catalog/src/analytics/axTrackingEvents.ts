...
import { AXSendTrackingActionType } from "./types";
...
type TPurchaseMeta = {
  ...
  purchaseType?: string;
  // The cart site coerces, every other site passes the current user id through; both shapes are
  // what the Angular original put on the wire.
