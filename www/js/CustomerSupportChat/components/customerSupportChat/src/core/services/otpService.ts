...
export const sendCode = async (params: TSendCodeRequest): Promise<TSendCodeResponse> => {
  ...
  const { data } = await http.post<TSendCodeResponse>(urlConfig, params);
  return data;
};
...
export const resendCode = async (params: TResendCodeRequest): Promise<TResendCodeResponse> => {
  ...
  const { data } = await http.post<TResendCodeResponse>(urlConfig, params);
  return data;
};
...
export const validateCode = async (
  ...
  const { data } = await http.post<TValidateCodeResponse>(urlConfig, params);
  return data;
};
