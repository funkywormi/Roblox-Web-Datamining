...
const FaePrologue = ({
  ...
  const [requireFaeModal, requireFaeModalService] = useModal({
    ...
    size: 'sm',
    onHide: () => {
      sendVerifyCancelClickEvent(featureName, 'Fae', settingName, recourseParameters ?? undefined, source);
      onHide();
    },
    onNeutral: () => {
      sendVerifyCancelClickEvent(featureName, 'Fae', settingName, recourseParameters ?? undefined, source);
  ...
  useEffect(() => {
    ...
    sendInitialUpsellPageLoadEvent(featureName, 'Fae', settingName, recourseParameters ?? undefined, source);
  }, []);
