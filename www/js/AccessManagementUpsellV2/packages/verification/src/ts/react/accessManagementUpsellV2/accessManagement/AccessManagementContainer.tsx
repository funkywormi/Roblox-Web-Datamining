...
function AccessManagementContainer({
  ...
  const [featureSpecificParams, setFeatureSpecificParams] = useState<TFeatureSpecificData | undefined>();
  ...
  useEffect(() => {
    const handleEvent = onAccessManagementCustomEvent as unknown as EventListener;
  ...
  }, [featureAccess, shouldSetStagePrologue, vpcV2PolicyEnabled, vpcExcludedRequestTypes]);
