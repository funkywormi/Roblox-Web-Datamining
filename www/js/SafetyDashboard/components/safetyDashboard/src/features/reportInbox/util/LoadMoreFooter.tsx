...
/**
 * Compact feedback for infinite-scroll pagination on the reports list. While the
 ...
 *
 * Based on LoadMoreFooter in violations/util
 */
const LoadMoreFooter = ({ isLoading, isError, onRetry, onClose }: LoadMoreFooterProps) => {
   ...
   * no matter what in order to reserve space and minimize layout shifts.
   */
        ...
        (isLoading ? (
          ...
          >
            <span className="text-body-medium text-wrap content-inverse-emphasis">
              {translate("Label.LoadingReportsError")}
            </span>
