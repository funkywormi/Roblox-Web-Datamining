 ...
 *
 * User-facing copy is routed through `translate(...)` at each call site, not here.
 */
 ...
 * it never comes back on this device. Device-local: the badge returns on a new browser.
 */
